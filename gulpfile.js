...
gulp.task('dev', function () {
    runSequence(['sass', 'es6', 'js', 'jade', 'images', 'vendor', 'views'], ['sass:watch', 'es6:watch', 'js:watch', 'jade:watch', 'images:watch', 'vendor:watch', 'views:watch'], 'server')
});
gulp.task('build', function () {
    runSequence(['sass', 'es6', 'js', 'jade', 'images', 'vendor', 'views'])
});
